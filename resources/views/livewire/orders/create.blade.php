<form>
    <div class="form-group mb-3">
        ...
        <input type="text" class="form-control @error('client_name') is-invalid @enderror" id="client_name"
            placeholder="Enter Name" wire:model="client_name">
        @error('client_name')
    ...
    <div class="form-group mb-3">
        ...
        <input type="text" class="form-control @error('final_price') is-invalid @enderror" id="final_price"
            placeholder="Enter final_price" wire:model="final_price">
        @error('final_price')
            <span class="text-danger">{{ $message }}</span>
        @enderror
    </div>
    <div class="form-group mb-3">
        ...
        <input type="text" class="form-control @error('final_price') is-invalid @enderror" id="quantity"
